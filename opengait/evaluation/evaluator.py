...
def single_view_gallery_evaluation(feature, label, seq_type, view, dataset, metric):
    probe_seq_dict = {'CASIA-B': {'NM': ['nm-05', 'nm-06'], 'BG': ['bg-01', 'bg-02'], 'CL': ['cl-01', 'cl-02']},
                      'OUMVLP': {'NM': ['00']},
                      'NRIPS-run-18angles-3km': {'NM': ['nm-05', 'nm-06']},
                      'NRIPS-run-18angles-7km': {'NM': ['nm-05', 'nm-06']},
                      'NRIPS-run-18angles-9km': {'NM': ['nm-05', 'nm-06']},
                      'NRIPS-run-18angles-AllSpeeds': {'NM': ['nm-05', 'nm-06'], 'SP3': ['sp3-01', 'sp3-02'], 'SP7': ['sp7-01', 'sp7-02'], 'SP9': ['sp9-01', 'sp9-02']},
    ...
    gallery_seq_dict = {'CASIA-B': ['nm-01', 'nm-02', 'nm-03', 'nm-04'],
                        'OUMVLP': ['01'],
                        'NRIPS-run-18angles-3km': ['nm-01', 'nm-02', 'nm-03', 'nm-04'],
                        'NRIPS-run-18angles-7km': ['nm-01', 'nm-02', 'nm-03', 'nm-04'],
                        'NRIPS-run-18angles-9km': ['nm-01', 'nm-02', 'nm-03', 'nm-04'],
                        'NRIPS-run-18angles-AllSpeeds': ['nm-01', 'nm-02', 'nm-03', 'nm-04'],
...
def evaluate_indoor_dataset(data, dataset, metric='euc', cross_view_gallery=False):
    ...
    if dataset not in ('CASIA-B', 'OUMVLP', 'NRIPS-run-18angles-3km', 'NRIPS-run-18angles-7km', 'NRIPS-run-18angles-9km', 'NRIPS-run-18angles-AllSpeeds', 'CASIA-E', 'SUSTech1K'):
